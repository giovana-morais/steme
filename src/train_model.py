...
def train_model(model, model_name, train_data, validation_data, epochs, early_stopping):
...
def main(model_name, epochs, early_stopping, main_file,
    ...
    model = train_model(model=model, model_name=model_name, train_data=train_dataset,
