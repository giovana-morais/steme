        ...
        with h5py.File(evaluation_file, "a") as whf:
            for track_id in ballroom.track_ids:
                ...
                for i in range(T.shape[1]):
                    s1, sh1, s2, sh2, _ = dt.get_tempogram_slices(T,
                            slice_idx=i, kmin=kmin, kmax=kmax)

                    fixed_s1, fixed_sh1, _, _, _ = dt.get_tempogram_slices(T,
                            slice_idx=i, kmin=kmin, kmax=kmax, shift_1=0,
                            shift_2=0)
                    ...
                    fixed_xhat1, fixed_xhat2, fixed_y1, fixed_y2 = model.predict([fixed_s1, fixed_s1, fixed_sh1, fixed_sh1], verbose=0)
